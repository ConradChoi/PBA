...
const zhTW = {
  ...
  privacy: {
    ...
    section3: {
      ...
      items: [
        "診斷、申請諮詢時蒐集的個人資料：自蒐集日起 1 年。但資料主體撤回同意或請求刪除時，將立即銷毀。",
    ...
    section4: {
      ...
      body: "保存期間已過或處理目的已達成的個人資料，將立即銷毀。電子檔形式的資訊，會以無法復原的方法永久刪除。",
    },
    section5: {
    ...
    section8: {
      ...
      body: "資料主體可以隨時要求本公司查閱、更正、刪除個人資料，停止處理以及撤回同意。若以電子郵件向下列個人資料保護負責人提出請求，我們會立即（10 天內）處理。也可以透過法定代理人或受委任人行使權利。",
    },
    section9: {
      title: "9. 個人資料的安全維護措施",
      items: [
