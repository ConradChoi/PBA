...
const zhCN = {
  ...
  privacy: {
    ...
    section3: {
      ...
      items: [
        "诊断、申请咨询时收集的个人信息：自收集之日起 1 年。但信息主体撤回同意或者请求删除时，立即销毁。",
    ...
    section4: {
      ...
      body: "保有期限已过或者处理目的已达成的个人信息，立即销毁。电子文件形式的信息，以无法恢复的方法永久删除。",
    },
    section5: {
    ...
    section8: {
      ...
      body: "信息主体可以随时要求公司查阅、更正、删除个人信息，停止处理以及撤回同意。通过邮件向下述个人信息保护负责人提出请求的，我们将立即（10 天以内）采取措施。也可以通过法定代理人或者受委托人行使权利。",
    },
    section9: {
